...
public class SmartArrayAppTest {
    ...
    public void testFilterPositiveIntegersSortAndMultiplyByTwo() {
        ...
        Integer[] res = SmartArrayApp.filterPositiveIntegersSortAndMultiplyByTwo(integers);
        Integer[] expectedRes = {2, 4, 6};
        assertArrayEquals(expectedRes, res);
    }

    @Test
    public void testFindDistinctStudentNames() {
        Student[] students = {
                ...
                new Student("Burr", "Sutter", 4.2, 2)};
        String[] studentNames =
                SmartArrayApp.findDistinctStudentNames(students);
